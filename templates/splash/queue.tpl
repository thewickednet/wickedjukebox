            ...
            <h1>Queue</h1>
            {if count($QUEUE) ne '0'}
            <ul {if $CORE->permissions.admin eq '1'}id="queue_list" {/if}>
            ...
            {/foreach}
                ...
                <li style="border-bottom: 0px solid #eeeeee; padding-top: 5px;"><b>Total:</b> {$QUEUE_TOTAL.totaltime|date_format:"%M:%S"}{if $CORE->permissions.queue_remove eq '1' || $CORE->permissions.admin eq '1'} - <a href="javascript:;" onclick="javascript:cleanqueue('splash');" style="color: red;">clean queue</a>{/if}</li>
	...
	$(function() {
		...
		$("#queue_list").disableSelection();
            ...
            <p><a href="javascript:;" onclick="javascript:refreshQueue('splash');"><img src="/images/arrow_rotate_clockwise.png" border="0" title="refresh" /></a></p>
