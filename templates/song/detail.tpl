            ...
            <div style="float: right"><a href="javascript:;" onclick="javascript:setStanding({$SONG.id}, 'love', 'detail');"><img src="/images/emoticon_happy.png" title="love this track!" border="0" class="icon{if $STANDING == 'love'}a{/if}"/></a>&nbsp;<a href="javascript:;" onclick="javascript:setStanding({$SONG.id}, 'neutral', 'detail');"><img src="/images/emoticon_smile.png" title="this track is ok!" border="0" class="icon{if $STANDING != 'love' && $STANDING != 'hate'}a{/if}"/></a>&nbsp;<a href="javascript:;" onclick="javascript:setStanding({$SONG.id}, 'hate', 'detail');"><img src="/images/emoticon_unhappy.png" title="sorry, not for me!" border="0" class="icon{if $STANDING == 'hate'}a{/if}"/></a>&nbsp;<a href="javascript:;" onclick="javascript:setStanding({$PLAYER_STATUS.songinfo.id}, 'broken');"><img src="/images/error.png" title="report track as broken or very bad quality" border="0" class="icon" /></a></div>
            </h2>
