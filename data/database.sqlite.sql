...
BEGIN;
   ...
   INSERT INTO setting (var,value,comment) VALUES ( 'mediadir', '/var/samba/media/audio', 'comma separated list of folders containing 
audio files');
   ...
   INSERT INTO setting (var,value,comment) VALUES ( 'lastfm_user', 'doc-twn', 'LastFM user name');
