...
BEGIN;
   ...
   INSERT INTO setting (var,value,comment) VALUES ( 'scoring_neverPlayed', 10, 'weight of the fact that a song has never been played for the random_weighed module');
